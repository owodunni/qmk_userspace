 ...
 */
    [_QWERTY] = LAYOUT_elora_hlc(
     ...
     KC_LSFT , KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,   KC_B , KC_LBRC,   KC_APP,     FKEYS  , KC_RBRC, KC_N,   KC_M ,KC_COMM, KC_DOT ,KC_SLSH, KC_RSFT,
                                ADJUST , KC_LGUI,   NAV_ESC, SYM_SPC, MS_BTN1,     SYM    , SYM_ENT, KC_BSPC,  KC_RGUI, KC_APP,
