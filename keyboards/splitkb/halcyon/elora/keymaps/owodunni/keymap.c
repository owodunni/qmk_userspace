 ...
 */
    [_QWERTY] = LAYOUT_elora_hlc(
     ...
     KC_BSLS , KC_A ,  GUI_S  ,  ALT_D ,   CTL_F,   KC_G ,                                           KC_H,   KC_J ,  KC_K ,   KC_L ,KC_SCLN,CTL_QUOT,
     KC_LSFT , KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,   KC_B ,   MS_RGHT, MS_BTN5,    FKEYS  , KC_RBRC, GUI_N,  CTL_M , KC_COMM, KC_DOT ,KC_SLSH, KC_RSFT,
                                ADJUST , MS_BTN8,   NAV_ESC, SYM_SPC, MS_BTN1,    MS_BTN2, SYM_ENT, KC_BSPC,  KC_RGUI, KC_APP,
 ...
 */
    [_SYM] = LAYOUT_elora_hlc(
     ...
     KC_TILD , KC_EXLM,  KC_AT , KC_HASH,  KC_DLR, KC_PERC,                                     _______, KC_EQL,  KC_LCBR, KC_PLUS, KC_RCBR, _______,
     KC_PIPE , KC_BSLS, KC_COLN, KC_SCLN, KC_MINS, KC_LBRC, KC_LCBR, _______, _______, KC_RCBR, _______, _______, KC_LBRC, _______, KC_RBRC, _______,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
     _______, _______,  _______, _______, _______,                                                       _______, _______, _______, _______, _______
    ),
